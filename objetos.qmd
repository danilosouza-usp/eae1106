...
Nesse capítulo você utilizará essencialmente funções nativas do Python. No entanto, para trabalhar com padrões textuais de forma mais profunda utilizaremos pacotes externos:
