...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, leftrule=.75mm, arc=.35mm, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, breakable, left=2mm, bottomrule=.15mm, titlerule=0mm, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, rightrule=.15mm, colback=white, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, leftrule=.75mm, arc=.35mm, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, breakable, left=2mm, bottomrule=.15mm, titlerule=0mm, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{O que significam as especificações do seu computador?}, rightrule=.15mm, colback=white, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, leftrule=.75mm, arc=.35mm, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, left=2mm, bottomrule=.15mm, titlerule=0mm, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Curiosidade}, rightrule=.15mm, colback=white, toprule=.15mm]
...
\caption{\label{fig-olddesk}Blocos que formam a Grande Pirâmide de Gizé
e Pirâmide de Quéops ao fundo, 2024.}
...
\item
  ...
  \texttt{\{.python\ .cell-code\}\ \ print(str\_example.upper())\ \ print(str\_example.lower())}
...
\item
  ...
  ::: \{.cell execution\_count=12\}
  \texttt{\{.python\ .cell-code\}\ \ print(str\_example.strip())}

  ::: \{.cell-output .cell-output-stdout\} \texttt{Hello,\ World} :::
  :::
\item
  ...
  ::: \{.cell execution\_count=13\}
  \texttt{\{.python\ .cell-code\}\ \ print(str\_example.startswith(\textquotesingle{}\ \textquotesingle{}))\ \ print(str\_example.endswith(\textquotesingle{}d\textquotesingle{}))}

  ::: \{.cell-output .cell-output-stdout\} \texttt{True\ \ True} ::: :::
\item
  ...
  ::: \{.cell execution\_count=14\}
  \texttt{\{.python\ .cell-code\}\ \ print(str\_example.find(\textquotesingle{},\textquotesingle{}))}

  ::: \{.cell-output .cell-output-stdout\} \texttt{6} ::: :::
\item
  ...
  \texttt{\{.python\ .cell-code\}\ \ print(str\_example.replace(\textquotesingle{}Hello\textquotesingle{},\textquotesingle{}World\textquotesingle{}))}

  ::: \{.cell-output .cell-output-stdout\} \texttt{World,\ World} :::
  :::
\end{enumerate}
...
\item
  ...
  list\_example.append(`g')

  print(list\_example) ```

  ::: \{.cell-output .cell-output-stdout\}
  \texttt{{[}\textquotesingle{}a\textquotesingle{},\ \textquotesingle{}c\textquotesingle{},\ \textquotesingle{}b\textquotesingle{},\ \textquotesingle{}g\textquotesingle{}{]}}
  ::: :::
\item
  ...
  ::: \{.cell execution\_count=28\} ``` \{.python .cell-code\} l2 =
  {[}`e',`d',`f'{]} list\_example.extend(l2)

  print(list\_example) ```

  ::: \{.cell-output .cell-output-stdout\}
  \texttt{{[}\textquotesingle{}a\textquotesingle{},\ \textquotesingle{}c\textquotesingle{},\ \textquotesingle{}b\textquotesingle{},\ \textquotesingle{}g\textquotesingle{},\ \textquotesingle{}e\textquotesingle{},\ \textquotesingle{}d\textquotesingle{},\ \textquotesingle{}f\textquotesingle{}{]}}
  ::: :::
\item
  \textbf{lista\_example.sort()}: classifica os elementos de
  ``lista\_example'' em ordem ascendente.

  ::: \{.cell execution\_count=29\} ``` \{.python .cell-code\}
  list\_example.sort()

  print(list\_example) ```

  ::: \{.cell-output .cell-output-stdout\}
  \texttt{{[}\textquotesingle{}a\textquotesingle{},\ \textquotesingle{}b\textquotesingle{},\ \textquotesingle{}c\textquotesingle{},\ \textquotesingle{}d\textquotesingle{},\ \textquotesingle{}e\textquotesingle{},\ \textquotesingle{}f\textquotesingle{},\ \textquotesingle{}g\textquotesingle{}{]}}
  ::: :::
\item
  ...
  list\_example.remove(`e')

  print(list\_example) ```

  ::: \{.cell-output .cell-output-stdout\}
  \texttt{{[}\textquotesingle{}a\textquotesingle{},\ \textquotesingle{}b\textquotesingle{},\ \textquotesingle{}c\textquotesingle{},\ \textquotesingle{}d\textquotesingle{},\ \textquotesingle{}f\textquotesingle{},\ \textquotesingle{}g\textquotesingle{}{]}}
  ::: :::
\end{enumerate}
...
\begin{verbatim}
<zip object at 0x000001A244CCC340>
\end{verbatim}
...
\item
  ...
  ::: \{.cell execution\_count=57\} ``` \{.python .cell-code\}
  dict\_update = \{`four':4,`five':5,`six':6\}

  dict\_example.update(dict\_update) print(dict\_example) ```

  ::: \{.cell-output .cell-output-stdout\}
  \texttt{\{\textquotesingle{}one\textquotesingle{}:\ 1,\ \textquotesingle{}two\textquotesingle{}:\ 2,\ \textquotesingle{}three\textquotesingle{}:\ 3,\ \textquotesingle{}four\textquotesingle{}:\ 4,\ \textquotesingle{}five\textquotesingle{}:\ 5,\ \textquotesingle{}six\textquotesingle{}:\ 6\}}
  ::: :::
\item
  ...
  ::: \{.cell execution\_count=58\}
  \texttt{\{.python\ .cell-code\}\ \ print(dict\_example.keys())}

  ::: \{.cell-output .cell-output-stdout\}
  \texttt{dict\_keys({[}\textquotesingle{}one\textquotesingle{},\ \textquotesingle{}two\textquotesingle{},\ \textquotesingle{}three\textquotesingle{},\ \textquotesingle{}four\textquotesingle{},\ \textquotesingle{}five\textquotesingle{},\ \textquotesingle{}six\textquotesingle{}{]})}
  ::: :::
\item
  ...
  ::: \{.cell execution\_count=59\}
  \texttt{\{.python\ .cell-code\}\ \ print(dict\_example.items())}

  ::: \{.cell-output .cell-output-stdout\}
  \texttt{dict\_items({[}(\textquotesingle{}one\textquotesingle{},\ 1),\ (\textquotesingle{}two\textquotesingle{},\ 2),\ (\textquotesingle{}three\textquotesingle{},\ 3),\ (\textquotesingle{}four\textquotesingle{},\ 4),\ (\textquotesingle{}five\textquotesingle{},\ 5),\ (\textquotesingle{}six\textquotesingle{},\ 6){]})}
  ::: :::
\item
  ...
  ::: \{.cell execution\_count=60\}
  \texttt{\{.python\ .cell-code\}\ \ print(dict\_example.get(\textquotesingle{}one\textquotesingle{}))}

  ::: \{.cell-output .cell-output-stdout\} \texttt{1} ::: :::

  ::: \{.cell execution\_count=61\}
  \texttt{\{.python\ .cell-code\}\ \ print(dict\_example.get(\textquotesingle{}ten\textquotesingle{}))}

  ::: \{.cell-output .cell-output-stdout\} \texttt{None} ::: :::

  ::: \{.cell execution\_count=62\}
  \texttt{\{.python\ .cell-code\}\ \ print(dict\_example.get(\textquotesingle{}ten\textquotesingle{},\ \textquotesingle{}The\ key\ does\ not\ exist.\textquotesingle{}))}

  ::: \{.cell-output .cell-output-stdout\}
  \texttt{The\ key\ does\ not\ exist.} ::: :::
\end{enumerate}
...
\item
  ...
  ::: \{.cell execution\_count=63\}
  \texttt{\{.python\ .cell-code\}\ \ a=10\ \ b=3\ \ c=10.0\ \ d=1.25\ \ e=\textquotesingle{}10\textquotesingle{}}
  :::
\item
...
\begin{verbatim}
Essa é a iteração 1 e o número sorteado foi: 0.81
Essa é a iteração 2 e o número sorteado foi: 1.00
Essa é a iteração 3 e o número sorteado foi: 0.09
Essa é a iteração 4 e o número sorteado foi: 0.78
Essa é a iteração 5 e o número sorteado foi: 0.08
Essa é a iteração 6 e o número sorteado foi: 0.41
Essa é a iteração 7 e o número sorteado foi: 0.25
Essa é a iteração 8 e o número sorteado foi: 0.52
Essa é a iteração 9 e o número sorteado foi: 0.59
Essa é a iteração 10 e o número sorteado foi: 0.28
\end{verbatim}
...
\begin{verbatim}
Tempo necessário para a realização dos cálculos utilizando list comprehensions: 0.0936 segundos
Tempo necessário para a realização dos cálculos utilizando loop: 0.1239 segundos

A abordagem de loop demorou 32.4% mais tempo! Dê uma chance para list comprehensions ;)
\end{verbatim}
...
\begin{verbatim}
[ 37.76970605  -5.37256514 -14.94521682 -15.65094009 -35.01522047
   3.99297869 -38.72710982  14.77623422 -26.54675927  -7.00542099]
\end{verbatim}
...
\begin{verbatim}
[ 37.316025   -29.80603565  25.52136876 -31.91879466  15.72991807
 -23.08182436  -3.69635685  37.41776331 -26.47093142  12.07702684]
\end{verbatim}
...
\begin{verbatim}
[-15.31010417  -8.82651216  21.2230539  -13.14478315   6.50173686
 -24.07202442  35.13517499  23.66846268   8.17289876  -7.94053402]
\end{verbatim}
...
\begin{verbatim}
Tempo necessário para a realização dos cálculos utilizando arrays: 0.0123 segundos
Tempo necessário para a realização dos cálculos utilizando listas: 0.3337 segundos

A abordagem de listas demorou 26x mais tempo! Esqueça listas e use arrays ;)
\end{verbatim}
