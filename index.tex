...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-important-color!10!white, left=2mm, opacitybacktitle=0.6, arc=.35mm, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, coltitle=black, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, rightrule=.15mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, opacitybacktitle=0.6, arc=.35mm, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, coltitle=black, colback=white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{O que significam as especificações do seu computador?}, rightrule=.15mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, left=2mm, opacitybacktitle=0.6, arc=.35mm, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, coltitle=black, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Curiosidade}, rightrule=.15mm, titlerule=0mm]
...
\begin{verbatim}
<zip object at 0x0000023A1A930980>
\end{verbatim}
...
\begin{verbatim}
Essa é a iteração 0 e o número sorteado foi: 0.08
Essa é a iteração 1 e o número sorteado foi: 0.27
Essa é a iteração 2 e o número sorteado foi: 0.91
Essa é a iteração 3 e o número sorteado foi: 0.82
Essa é a iteração 4 e o número sorteado foi: 0.58
Essa é a iteração 5 e o número sorteado foi: 0.63
Essa é a iteração 6 e o número sorteado foi: 0.77
Essa é a iteração 7 e o número sorteado foi: 0.83
Essa é a iteração 8 e o número sorteado foi: 0.61
...
\begin{verbatim}
Tempo necessário com list comprehensions: 0.0923 segundos
Tempo necessário com loop: 0.1203 segundos

A abordagem de loop demorou 30.4% mais tempo!
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, opacitybacktitle=0.6, arc=.35mm, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, coltitle=black, colback=white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Teorema Central do Limite}, rightrule=.15mm, titlerule=0mm]
...
\begin{verbatim}
[ 29.55374641   4.6021209  -18.05953531  31.29070794 -39.76796778
  -0.81656245  15.70026517 -35.31344546 -36.91283848 -34.3078271 ]
\end{verbatim}
...
\begin{verbatim}
[ 10.02318676 -24.89628323 -32.4940965    8.88111845 -39.53807417
  26.354943    36.20418904 -11.27105506  39.19798271 -15.95749705]
\end{verbatim}
...
O comando \texttt{return} é usado para especificar qual será o resultado
de uma função. Essa declaração pode ter um comando que é executado e o
valor resultante devolvido. Se esse comando não for anexado ou não tiver
nada além do \texttt{return}, a função é devolvida com o valor de
\texttt{None}. Por exemplo:
...
\NormalTok{x }\OperatorTok{=}\NormalTok{ my\_func(}\StringTok{\textquotesingle{}Emily\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}Paris\textquotesingle{}}\NormalTok{)}
\BuiltInTok{print}\NormalTok{(x)}
\end{Highlighting}
\end{Shaded}
...
realizar algum tipo de operação e atribuir a algum objeto o valor dessa
operação para uso posterior, não podemos esquecer do \texttt{return}.
Vejamos o exemplo da função que calcula a raiz quadrada de um número:
...
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor1}{Cell}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor1}{ }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor3}{In[19]}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor3}{, line 1}\textcolor{QuartoInternalColor2}{}
...
\textcolor{black}{}\textcolor{QuartoInternalColor4}{---------------------------------------------------------------------------}\textcolor{QuartoInternalColor2}{}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor4}{NameError}\textcolor{QuartoInternalColor2}{                                 Traceback (most recent call last)}
\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor1}{Cell}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor1}{ }\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor3}{In[22]}\textcolor{QuartoInternalColor2}{}\textcolor{QuartoInternalColor3}{, line 1}\textcolor{QuartoInternalColor2}{}
...
Em Python, uma função anônima é uma função definida sem nome. Enquanto
as funções normais são definidas usando a palavra-chave \texttt{def} em
Python, as funções anônimas são definidas usando a palavra-chave
\texttt{lambda}. Por essa razão, funções anônimas também são chamadas de
funções lambda. A estrutura usual de uma função lambda é a seguinte:
...
Tempo necessário para a realização dos cálculos utilizando listas: 0.2910 segundos
