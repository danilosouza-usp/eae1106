...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, breakable, bottomtitle=1mm, left=2mm, colframe=quarto-callout-important-color-frame, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, toptitle=1mm, leftrule=.75mm, colback=white, colbacktitle=quarto-callout-important-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, opacityback=0, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, breakable, bottomtitle=1mm, left=2mm, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{O que significam as especificações do seu computador?}, toptitle=1mm, leftrule=.75mm, colback=white, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, opacityback=0, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, breakable, bottomtitle=1mm, left=2mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Curiosidade}, toptitle=1mm, leftrule=.75mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, opacityback=0, coltitle=black]
...
\begin{verbatim}
<zip object at 0x0000018BF70C6140>
\end{verbatim}
...
\begin{verbatim}
Essa é a iteração 0 e o número sorteado foi: 0.98
Essa é a iteração 1 e o número sorteado foi: 0.10
Essa é a iteração 2 e o número sorteado foi: 0.63
Essa é a iteração 3 e o número sorteado foi: 0.57
Essa é a iteração 4 e o número sorteado foi: 0.37
Essa é a iteração 5 e o número sorteado foi: 0.99
Essa é a iteração 6 e o número sorteado foi: 0.24
Essa é a iteração 7 e o número sorteado foi: 0.25
Essa é a iteração 8 e o número sorteado foi: 0.42
Essa é a iteração 9 e o número sorteado foi: 0.62
\end{verbatim}
...
\BuiltInTok{print}\NormalTok{(}\StringTok{\textquotesingle{}}\CharTok{\textbackslash{}n}\StringTok{A abordagem de loop demorou }\SpecialCharTok{\{:.1\%\}}\StringTok{ mais tempo!}\CharTok{\textbackslash{}n}\StringTok{Dê uma chance para list comprehensions ;)\textquotesingle{}}\NormalTok{.}\BuiltInTok{format}\NormalTok{(ratio }\OperatorTok{{-}} \DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
Tempo necessário com list comprehensions: 0.0951 segundos
Tempo necessário com loop: 0.1244 segundos

A abordagem de loop demorou 30.8% mais tempo!
...
Esse exercício é o mais complexo que fizemos até agora no curso. Nele
utilizamos grande parte dos conceitos que estudamos até aqui, desde
listas a loops e também a importação de bibliotecas de comandos. Você
pode pular essa parte por enquanto, mas aconselho que aos poucos você
tente replicá-lo, de forma a entender todas suas etapas com o tempo.
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, breakable, bottomtitle=1mm, left=2mm, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Teorema Central do Limite}, toptitle=1mm, leftrule=.75mm, colback=white, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, opacityback=0, coltitle=black]
...
\begin{verbatim}
[ 27.29180398  38.10424199 -23.22884644 -21.18110005  34.11443477
  -6.83511399 -12.52312673  10.69876286   3.87091794 -20.97754643]
\end{verbatim}
...
\begin{verbatim}
[ 24.66499973 -39.33137829 -37.79225377  18.37874695  30.42409441
   8.68093049  19.4425781  -20.19313432   9.69329897  25.73432598]
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Agora que o seed já foi definido, o resultado deve ser o mesmo.}
\NormalTok{x }\OperatorTok{=}\NormalTok{ np.random.uniform(}\OperatorTok{{-}}\DecValTok{40}\NormalTok{, }\DecValTok{40}\NormalTok{, }\DecValTok{10}\NormalTok{)}
\BuiltInTok{print}\NormalTok{(x)}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
[ -6.46443885  14.81756003 -23.64382002  30.24939491 -37.80899254
  13.63740081  -6.61561581   4.69518628 -28.76904491 -24.15188087]
\end{verbatim}
...
\begin{verbatim}
[np.float64(-0.55), np.float64(5.0), np.float64(-5.57), np.float64(2.37), np.float64(5.47), np.float64(1.56), np.float64(3.95), np.float64(-0.69), np.float64(-2.88), np.float64(-0.33)]
\end{verbatim}
...
\begin{verbatim}
[  4.79922447 -33.66815955  29.15504282   6.48504628  19.31805475
  22.60653926   9.46442386  -0.09067829  27.40662044 -20.65023947]
\end{verbatim}
...
\begin{verbatim}
Tempo necessário para a realização dos cálculos utilizando arrays: 0.0128 segundos
Tempo necessário para a realização dos cálculos utilizando listas: 0.2887 segundos
