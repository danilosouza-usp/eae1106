...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, toprule=.15mm, breakable, rightrule=.15mm, opacityback=0, coltitle=black, colbacktitle=quarto-callout-important-color!10!white, left=2mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, bottomrule=.15mm, colback=white, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}]
...
\includegraphics[width=7.29167in,height=\textheight,keepaspectratio]{images/IA.png}
...
muito rápido. No entanto, a IA não entende objetivos de aprendizagem,
não conhece a sequência didática adotada e não distingue soluções
apropriadas de soluções excessivamente complexas para o nível do aluno.
Por esse motivo, o uso acrítico dessas ferramentas pode gerar
dependência, dificultar a internalização de conceitos básicos como tipos
de dados, controle de fluxo e escopo de variáveis.
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toprule=.15mm, breakable, rightrule=.15mm, opacityback=0, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, left=2mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, bottomrule=.15mm, colback=white, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Curiosidade}]
...
modelo. A Figura Figura~\ref{fig-chatgpt} apresenta o layout base do
ChatGPT em seu website.

\begin{figure}

\begin{minipage}{0.50\linewidth}

\pandocbounded{\includegraphics[keepaspectratio]{images/chatgpt1.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/chatgpt2.jpeg}}
...
\includegraphics[width=7.29167in,height=\textheight,keepaspectratio]{images/chatgpt3.png}
...
\includegraphics[width=10.67in,height=9.04in]{inteligencia_artificial_files/figure-latex/mermaid-figure-1.png}

\subsection{Conceitos básicos de engenharia de
prompt}\label{conceitos-buxe1sicos-de-engenharia-de-prompt}

Um prompt é a instrução ou pergunta fornecida à ferramenta de IA. A
qualidade da resposta depende fortemente da clareza, do contexto e das
restrições explícitas incluídas no prompt. Prompts vagos tendem a gerar
respostas genéricas ou excessivamente complexas. Já prompts bem
...
\includegraphics[width=7.29167in,height=\textheight,keepaspectratio]{images/prompts.jpg}
...
pagar pelo uso da API.\footnote{Existem diversas outras ferramentas que
  oferecem serviços parecidos e até mais eficazes em alguns projetos que
  envolvem programação e códigos, como o
  \href{https://claude.ai/}{Claude} ou mesmo o
  \href{https://ai.google.dev/gemini-api/docs?hl=pt-br}{Gemini}. Tudo
  vai depender das suas preferências e do seu bolso.}

Para utilizar a API, o usuário cadastra um cartão de crédito e, ao final
do mês, é cobrado pelo número e complexidade das demandas. É possível
configurar limites de uso de modo a evitar gastos maiores do que o
esperado. O preço é diferente para modelos diferentes.
...
A regra prática é simples: se você não conseguir reconstruir ou adaptar
a solução sem a ferramenta de IA, então você não compreendeu a resposta
...
\begin{verbatim}
Essa é a iteração 1 e o número sorteado foi: 0.99
Essa é a iteração 2 e o número sorteado foi: 0.96
Essa é a iteração 3 e o número sorteado foi: 0.60
Essa é a iteração 4 e o número sorteado foi: 0.57
Essa é a iteração 5 e o número sorteado foi: 0.89
Essa é a iteração 6 e o número sorteado foi: 0.66
Essa é a iteração 7 e o número sorteado foi: 0.80
Essa é a iteração 8 e o número sorteado foi: 0.65
Essa é a iteração 9 e o número sorteado foi: 0.59
Essa é a iteração 10 e o número sorteado foi: 0.11
\end{verbatim}
...
\begin{verbatim}
Tempo necessário para a realização dos cálculos utilizando list comprehensions: 0.0940 segundos
Tempo necessário para a realização dos cálculos utilizando loop: 0.1234 segundos

A abordagem de loop demorou 31.3% mais tempo! Dê uma chance para list comprehensions ;)
\end{verbatim}
...
\begin{verbatim}
[ 22.85781881   8.22297984  16.80974929 -25.05844376  25.86884191
 -20.30396433  -6.84360551  15.30392108  12.97155145 -19.32129174]
\end{verbatim}
...
\begin{verbatim}
[  4.85557782 -38.97337363   6.62480042 -13.37155591   2.46713124
  -9.45071618  24.13652871  -8.63288231  10.16175861  -2.9976376 ]
\end{verbatim}
...
\begin{verbatim}
[ 35.6796348   23.76606799  -9.94123648   9.54840462 -14.91948354
  17.12708736  27.64184913  -1.89516023   2.94807482  22.31166181]
\end{verbatim}
...
\begin{verbatim}
Tempo necessário para a realização dos cálculos utilizando arrays: 0.0132 segundos
Tempo necessário para a realização dos cálculos utilizando listas: 0.2966 segundos
