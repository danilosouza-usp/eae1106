...
# Séries a serem plotadas
ax[0,0].hist(df_covid_top10['pop'],color='#1f77b4',bins=20)
ax[0,1].hist(df_covid_top10['emp'],color='#1f77b4',bins=20)
ax[1,0].hist(df_covid_top10['avh'],color='#1f77b4',bins=20)
ax[1,1].hist(df_covid_top10['pibpc'],color='#1f77b4',bins=20)
...
ax[1,1].set_title('PIB per capita', fontsize=8, fontweight='light')
