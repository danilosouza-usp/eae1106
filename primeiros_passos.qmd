...
Essas competências serão usadas continuamente ao longo do curso e são essenciais para o desenvolvimento em tópicos futuros, como construção de funções, manipulação de objetos, análise de dados e visualização.
...
1. Inicialize o interpretador do Python e use-o como uma calculadora. Responda as seguintes perguntas:
   ...
   a. Quantas milhas há em 10 quilômetros? Dica: uma milha equivale a 1,61 quilômetro.
   a. Se você correr 10 quilômetros em 42 minutos e 42 segundos, qual é o seu passo médio (tempo por milha em minutos e segundos)? Qual é a sua velocidade média em milhas por hora?
