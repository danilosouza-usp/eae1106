...
Neste capítulo aprenderemos como instalar o Python e outros pacotes. Ele foi escrito para que o aluno que acompanhou e absorveu o conteúdo do capítulo anterior, sobre fundamentos de computação, tenha capacidade de acompanhar.
...
![Indíce PyPL de popularidade de linguagens](images/pypl_index.jpg){#fig-pypl width=700px max-width=100% fig-align="center"}
...
![Tela de download da distribuição Anaconda](images/anaconda_download.jpg){#fig-anaconda1 width=800px max-width=100% fig-align="center"}
...
![Tela de instalação da distribuição Anaconda](images/anaconda_install.jpg){#fig-anaconda2 width=400px max-width=100% fig-align="center"}
...
![Tela inicial do Anaconda Navigator](images/anaconda_navigator.jpg){#fig-anaconda3 width=800px max-width=100% fig-align="center"}
