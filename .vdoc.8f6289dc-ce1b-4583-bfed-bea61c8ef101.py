...
#
#
exp = [15,13,12,13,18,3,18,11,16,9,8,11,14,6,4,7,9,15]
sal = [99,93,94,88,111,86,103,87,94,90,77,85,86,81,83,81,84,96]

print('O terceiro indivíduo possui experiência igual a {} anos e um salário de R${} por hora.'.format(exp[2],sal[2]))
#
#
#
#
