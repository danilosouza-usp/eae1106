...
No entanto, nem sempre as ferramentas de inteligência artificial são indicadas. Independentemente do contexto, as três perguntas abaixo ajudam a compreender se na sua aplicação, modelos de IAG são úteis e indicados ou se podem gerar respostas pouco eficazes e até mesmo problemas com ética e compartilhamento de dados.
...
flowchart TB
    ...
    classDef decision fill:#f7f7f7,color:#000000,stroke-width:0px;
