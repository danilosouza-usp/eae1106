...
O terminal é uma interface textual que permite interagir com o sistema operacional por meio de comandos. Diferente de interfaces gráficas (como clicar em ícones), no terminal você descreve explicitamente o que deseja que o computador faça. A Figura @fig-terminal mostra como é o ambiente usual do terminal nos dois principais sistemas operacionais do mercado.
...
Mesmo que você utilize interfaces gráficas, compreender o terminal facilita a compreensão de como o computador está organizado. Ao longo do curso, ele será utilizado principalmente para executar programas, navegar entre diretórios e instalar novos pacotes de comandos.
