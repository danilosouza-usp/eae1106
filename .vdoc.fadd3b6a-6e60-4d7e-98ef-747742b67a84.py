...
x_ticks=[4,5,6,7,8]
y_ticks=[-2,0,2,4,6]
x_tickslabel=['$4$','$5$','$6$','$7$','$8$']
y_tickslabel=['$-2$','$0$','$2$','$4$','$6$']

x = np.log(HomicidioPolicia2015['police'])
y = np.log(HomicidioPolicia2015['hrate'])
...
ax.scatter(x,y,alpha=1.0,color=color, s=120)
...
#
df
result = sm.OLS(x,df_polh[['police_log','constante']]).fit()
