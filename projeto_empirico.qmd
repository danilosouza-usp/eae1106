...
![Exemplo de correlação entre variáveis não relacionadas. Fonte: https://tylervigen.com/spurious-correlations](images/disney_divorce.png){#fig-correlation width=450px max-width=100% fig-align="center"}
