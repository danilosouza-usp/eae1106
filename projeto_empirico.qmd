...
A base de dados original vem da _United Nations Office on Drugs and Crime (UNODC)_, divisão das Nações Unidas que trata de temas relacionados à drogas e crimes no âmbito internacional. Não entrarei nos detalhes do código para ajustar a base original, mas tudo que está presente ali já foi discutido em capítulos anteriores.
