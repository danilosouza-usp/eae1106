...
![Efeito Dunning-Kruger e a tendência de pessoas pouco experientes superestimarem seu próprio nível de conhecimento. Para saber mais sobre esse efeito, ver a [matéria no Jornal da USP.](https://jornal.usp.br/radio-usp/o-que-e-o-efeito-dunning-kruger/)](images/dunningkruger.jpg){#fig-olddesk width=700px max-width=100% fig-align="center"}
...
O foco deste capítulo será o pacote _Matplotlib_, que, apesar de já vir instalado com o Anaconda, não é nativo do Python e, portanto, é preciso carregá-lo. Para carregar e trabalhar com as bases de dados que utilizaremos para a construção dos gráficos, precisamos carregar também outras bibliotecas.
...
A Figura @fig-visualization replica um dos exemplos apresentados no artigo, partindo de um gráfico ``sujo'', com elementos visuais demais, confuso e que pouco comunica. O autor propõe algumas mudanças, na linha dos três princípios básicos acima, que, a partir do mesmo conjunto de dados, informa muito mais ao leitor.

::: {#fig-visualization layout-ncol=1 width=700px max-width=100% fig-align="center"}

![Gráfico original](images/vis1.jpg){width=600px}

![Gráfico redesenhado, com alterações nos elementos visuais](images/vis2.jpg){width=600px}

Exemplo de mudanças na estrutura do gráfico que aumentam seu conteúdo informacional. Fonte: _Schwabish (2014)_
:::

Apesar de ir além desses 3 princípios básicos, o artigo é apenas uma referência e exemplo do poder de visualizações construídas de forma ``correta''. Há outras várias fontes de informação sobre visualização (esse [link](https://datascience.quantecon.org/tools/visualization_rules.html) é uma ótima referência) e de como construir gráficos e visualizações a partir de uma ideia de _storytelling_, de utilizar dados e ferramentas gráficas para contar uma história e comunicar uma mensagem (o livro [Storytelling com dados](https://www.amazon.com.br/Storytelling-com-Dados-Visualiza%C3%A7%C3%A3o-Profissionais/dp/8550804681/ref=sr_1_1_sspa?keywords=storytelling+com+dados&qid=1668636806&qu=eyJxc2MiOiIxLjY5IiwicXNhIjoiMC45NiIsInFzcCI6IjAuNzYifQ%3D%3D&sprefix=story%2Caps%2C557&sr=8-1-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&psc=1) é outra ótima referência). Em resumo, construir um bom gráfico, uma visualização eficiente, é um trabalho de criatividade e de muita tentativa e erro. Uma determinada visualização pode funcionar muito bem para um certo tipo de dado e não funcionar para outros vários tipos. **Personalização** é a palavra chave nessa árdua tarefa de construir um bom gráfico.
