...
5. Escreva um _loop_ que parta de um número inteiro positivo e retorne ao fim do código a quantidade de dígitos pares que existem no número inicial.

6. O último teorema de _Fermat_ diz que não há nenhum número inteiro positivo _a,b,c_ tal que 
   $$ a^n + b^n = c^n $$
