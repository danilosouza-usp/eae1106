...
df_pwtdbr = df_pwt2[df_pwt2['pais']=='Brazil'][columns_to_keep]
df_pwtdus = df_pwt2[df_pwt2['pais']=='United States'][columns_to_keep]
...
#
#
df_pwtdbr = df_pwtdbr.groupby(by=['pais','decada'], as_index=False).mean()
