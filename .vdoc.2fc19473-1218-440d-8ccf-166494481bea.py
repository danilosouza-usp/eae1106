...
UberNYC_201912.info(memory_usage='deep')
#
#
#
#
...
#
#
columns_object = ['shared_request_flag','shared_match_flag','access_a_ride_flag','wav_request_flag','wav_match_flag']

UberNYC_201912.loc[0:5, columns_to_show]
#
#
#
#
...
#
#
UberNYC_201912[['PULocationID','DOLocationID']].describe()
#
#
#
#
